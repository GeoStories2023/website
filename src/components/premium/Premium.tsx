...
function Premium() {
  ...
  const content = [
    ...
    {
      icon: <Icon size={52} />,
      content: "weitere Abzeichen werden freigeschaltet",
    },
    {
      icon: <Icon size={52} />,
      content: "für 49,99€ im Jahr oder 4,99€ im Monat",
    },
  ];
          ...
          <div className="row">
            ...
            <div className="col-md-9">
              <div className="upgrade-description">
                <span className="premium-upgrade">
                  Jetzt anmelden und auf PRO-Version upgraden!
                </span>
                <span className="register">
                  Noch kein Konto? Dann schnell{" "}
      ...
      <div className="premium-description">
        <div className="premium-description-container">
          ...
          <span className="text-description">
            ...
            asperiores ullam accusantium tempore minima rerum, aperiam sed esse.
            Quo accusamus itaque architecto eveniet voluptate dicta autem
            repudiandae ex non cum!
          </span>
        </div>
      </div>
